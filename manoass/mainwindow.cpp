    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->ram_tb->horizontalHeader()->setStyleSheet("QHeaderView::section {background-color:rgb(255,225,250)}");

    setFixedSize(1400,785);
...
void MainWindow::on_compile_btn_clicked()
{
    ...
    for(int i=0;i<tcommmands;i++)
    {
        ...
        QStringList riz = commands.at(i).split(' ', QString::SkipEmptyParts);
            ...
            else if(riz.at(0)=="ADD")
            {
                ...
                if(firstallDatas[riz.at(1)]==0)
                {
                    ui->console->setText("Error in line:"+QString::number(i+1)+"label"+riz.at(1)+"  is Undefined !!");
                    compiled=0;
                    break;
            ...
            else
            {
                ...
                ui->console->setText(" Bad Command \n in line:"+QString::number(i+1)+"\n . \n");
    ...
    if(!endp1 && compiled)
    {
        ui->console->setText("compile err! \n END flag not found!\n");
        compiled=0;
    }
